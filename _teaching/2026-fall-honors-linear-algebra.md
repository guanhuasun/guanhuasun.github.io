...
<p class="course-page__eyebrow">MATH-UA 148-001 · Fall 2026 · 4 points</p>

<p class="course-page__summary">A rigorous first course in linear algebra that develops proof, computation, and geometric intuition together, from vector spaces and linear maps through spectral theory and the singular value decomposition.</p>

<p class="course-page__actions"><a class="btn" href="{{ page.catalog_url }}">Official course description</a></p>
...
| **Email** | [gs2658@nyu.edu](mailto:gs2658@nyu.edu) |
...
Students must satisfy one of the official prerequisites listed on the [MATH-UA 148 course page]({{ page.catalog_url }}). MATH-UA 140 Linear Algebra is an anti-requisite; students cannot receive credit for both courses.
...
1. solve linear systems and use matrices effectively;
2. reason with vector spaces, bases, dimension, linear transformations, and coordinates;
3. write clear proofs and connect abstract results with computation and geometry;
4. use determinants, orthogonality, eigenvalues, the spectral theorem, and the singular value decomposition; and
5. apply linear algebra to problems such as least squares, dynamical systems, and low-rank approximation.

## Texts and course materials

### Primary text

Sergei Treil, *Linear Algebra Done Wrong*, April 30, 2026 version. The book is legally available without charge from the [author’s webpage](https://www.math.brown.edu/streil/papers/LADW/LADW.html).
...
Gilbert Strang, *Introduction to Linear Algebra*, 6th edition, 2023. This [classic reference](https://math.mit.edu/~gs/linearalgebra/ila6/indexila6.html) is not freely available, but Strang’s YouTube lectures are highly recommended.

Sheldon Axler, *Linear Algebra Done Right*, 4th edition, 2024. The current electronic edition is legally available without charge from the [author’s webpage](https://linear.axler.net/). Axler offers especially useful alternative explanations and proofs. Selected companion readings may be recommended, but the course will not follow Axler’s order.

Dan Margalit and Joseph Rabinoff, [*Interactive Linear Algebra*](https://textbooks.math.gatech.edu/ila/), 2019. This free online text uses interactive visualizations and geometric explanations to build intuition for systems of equations, linear transformations, determinants, eigenvectors, orthogonality, and related topics.
...
The goal of homework is to develop reasoning that students can reproduce independently. The following rules apply unless a particular assignment explicitly gives different instructions.

### Permitted

- discussing general ideas and approaches with classmates, while producing an independent written solution;
- consulting the assigned texts, course notes, and resources explicitly authorized for the assignment;
- using a calculator, computer algebra system, numerical software, or generative-AI tool to **check work already completed independently**; and
- using computational tools when an assignment explicitly asks for computation.

### Not permitted

- asking another person or a generative-AI system to produce a solution, proof, outline, or key argument for an assigned problem;
- submitting text, mathematics, code, or reasoning generated by an AI system or another person, whether copied directly, paraphrased, translated, or rewritten;
- using online solution banks, answer-sharing sites, or unauthorized worked solutions; or
- sharing one’s written solution so that another student can copy or rewrite it.

All substantial assistance from a person, book, website, software system, or AI tool must be acknowledged clearly. Acknowledgment does not make otherwise prohibited help permissible. Every student is responsible for being able to explain every part of every submitted solution.

These course rules supplement the [Courant Mathematics academic-integrity policy](https://math.nyu.edu/dynamic/undergrad/ba-cas/academic-integrity/) and the honor code of the student’s school.
...
Students who may need academic accommodations should contact the [Moses Center for Student Accessibility](https://www.nyu.edu/students/communities-and-groups/student-accessibility.html) and provide the instructor with the official accommodation notice as early as possible. Accommodations are implemented prospectively and in coordination with the relevant university office.

## Tentative course calendar

The sequence below follows the chapter order of Treil’s April 30, 2026 edition. It may shift according to the pace and needs of the class. Changes to the topic schedule do not alter the published grading weights, assessment count, examination-aid rules, or academic-integrity policies. Assessment dates will change only if required by the university or by circumstances affecting the class as a whole, and any such change will be announced in writing.

<div class="course-table-scroll" markdown="1">
